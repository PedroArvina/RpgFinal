...
public class Acessório extends JPanel {
    ...
    private JLabel EldaraVida;
    private JLabel LacaioVida;
    ...
    public Acessório(ActionListener mudarTurnoListener) {
        ...
        statusPanel.add(new JLabel("Lacaio Fantasma HP: "));
        LacaioVida = new JLabel("1");
        statusPanel.add(LacaioVida);
        statusPanel.add(new JLabel("Eldara HP: "));
        EldaraVida = new JLabel("1000");
        statusPanel.add(EldaraVida);
    ...
    public void atualizarStatusLacaio(int hp) {
        LacaioVida.setText(String.valueOf(hp));
    }
    
 // Atualiza o status do Pug
    public void atualizarStatusEldara(int hp) {
        EldaraVida.setText(String.valueOf(hp));
    }
