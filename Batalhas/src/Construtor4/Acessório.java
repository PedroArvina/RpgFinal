...
public class Acessório extends JPanel {
    ...
    public Acessório(ActionListener mudarTurnoListener) {
        ...
        statusPanel.add(new JLabel("Pistoleiro Papaco HP: "));
        pugVida = new JLabel("50");
        statusPanel.add(pugVida);
        statusPanel.add(new JLabel("Pistoleiro Luiz HP: "));
        lugVida = new JLabel("70");
        statusPanel.add(lugVida);
        statusPanel.add(new JLabel("Pistoleiro Daniel HP: "));
        ...
        setPreferredSize(new Dimension(200, 400)); // Ajuste conforme necessário para melhor visualização
    }
