...
import Mob.SaudeInvalidaException;
...
public class Poderes {
    ...
    private void magoCura(Personagem personagem) {
        ...
        } catch (SaudeInvalidaException e) {
            System.err.println("Erro ao curar: " + e.getMessage());
            // Adicionalmente, você pode implementar alguma lógica de recuperação ou notificação aqui.
        }
    }
